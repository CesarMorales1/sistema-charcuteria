export class Factura {
  constructor({
    id_factura, id_proveedor, id_compra,
    numero_factura, fecha_emision, fecha_vencimiento,
    base_imponible, alicuota_iva, monto_iva, monto_total,
    id_moneda_monto, tasa_referencia, estado, eliminada,
    proveedor, pagos
  }) {
    this.id_factura = id_factura;
    this.id_proveedor = id_proveedor;
    this.id_compra = id_compra ?? null;
